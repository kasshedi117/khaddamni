package com.kass.khaddamni.khaddamni.widget;
...
public class LoadingButton extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            mRippleColorNew = ta.getColor(R.styleable.LoadingButton_rippleColornew,Color.BLACK);
            ta.recycle();
        }
        ...
        ripplePaint.setColor(mRippleColorNew);
